        ...
        <div class="row">
            ...
            <!--Navbar Section Ends-->
                ...
                <div id="demo">
                    ...
                    <div class="col-md-8">
                        <form style="border: solid 1px; padding: 50px 50px; margin-top: 3vh; box-shadow:1px 1px 20px 0px; " method="POST" action="addCourseProcess">

                            <div style="margin-top:0vh; text-align:center; padding-bottom: 40px;"><h1>Add Course</h1></div>
                            <div>${added}</div>
                            <div class="row g-2 justify-content-md-around">
                                
                                <div class="col-md-5">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="Branch Name" name="tcbranch" required>
                                        <label for="floatingInput">Branch Name</label>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="floatingInput" placeholder="No of Seats" name="tcseats" required>
                            ...
                            <div class="row g-2 justify-content-md-around">
                                ...
                                <div class="col-md-5">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="floatingInput" placeholder="Duration in Yrs" name="tcduration" required>
                                        <label for="floatingInput">Duration in Yrs</label>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="floatingInput" placeholder="No of Semesters" name="tcsems" required>
                            ...
                            <div class="row g-2 justify-content-md-evenly">
                                <div class="col-md-11">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="tcdescription" required></textarea>
