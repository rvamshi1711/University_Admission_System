...
<body>
    ...
    <div class="container ">
        <div class="row">
            ...
            <!--Navbar Section Ends-->
                <div id="demo">
                    <div style="margin-top:4vh; text-align:center;"><h1>Education Details</h1></div>
                <div class="row justify-content-md-evenly">
                    <div class="col-md-8">
			...
			try
			{
				...
				if(rs.next())
				{	
					String ss1= "SELECT * from educational_details where emailid = '"+c.getEmailid()+"';";
					Statement stmt2 = con.createStatement();
					ResultSet rs2 = stmt2.executeQuery(ss1);
					if(rs2.next())
					{
						%>
						<form style="border: solid 1px; padding: 50px 60px; margin-top: 3vh; box-shadow:1px 1px 20px 0px; " ">
                            <!--First and last name-->
                            <div class="row g-3 justify-content-md-around">
                                
                                <div class="col-md-2">
                                    <div class="form-floating mb-3">
                                    	<input type="hidden" name="emailid" value="<%=c.getEmailid() %>" />
                                        <input type="text" class="form-control" id="floatingInput" placeholder="First Name" value="10" readonly required>
                                        <label for="floatingInput">Class 10</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="Last Name" name="board10" value="<%=rs2.getString("board10") %>" readonly required>
                                ...
                                <div class="col-md-2">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="floatingInput" placeholder="First Name" name="percentage10" value="<%=rs2.getString("percentage10") %>" readonly required>
                            ...
                            <div class="row g-3 justify-content-md-around">
                                ...
                                <div class="col-md-2">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="First Name" value="12" readonly required>
                                        <label for="floatingInput">Class 12</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="Last Name" name="board12" value="<%=rs2.getString("board12") %>" readonly required>
                                        <label for="floatingInput">Board Name</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="floatingInput" placeholder="First Name" name="percentage12" value="<%=rs2.getString("percentage12") %>" readonly required>
                                        <label for="floatingInput">Percentage</label>
                                    </div>
                                </div>
					...
					%>
                        <form style="border: solid 1px; padding: 50px 60px; margin-top: 3vh; box-shadow:1px 1px 20px 0px; " enctype="multipart/form-data" method="post" action="educationaldetailsprocess">
                            <!--First and last name-->
                            <div class="row g-3 justify-content-md-around">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="Last Name" name="board10" required>
                                        <label for="floatingInput">Board Name</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="floatingInput" placeholder="First Name" name="percentage10" required>
                                        <label for="floatingInput">Percentage</label>
                                    </div>
                                </div>
                            ...
                            <div class="row g-3 justify-content-md-around">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="Last Name" name="board12"  required>
                                        <label for="floatingInput">Board Name</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="floatingInput" placeholder="First Name" name="percentage12" required>
                                        <label for="floatingInput">Percentage</label>
                                    </div>
                                </div>
...
<!-- Images Code
                            <div class="row g-2 justify-content-md-around">
                                ...
                                <div class="col-md-11">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" id="formFileLg" type="file" name="imagepic">
                                        </div>
                                ...
                                <div class="col-md-11">
                                        ...
                                        <div class="mb-3">
                                            <label for="formFileLg" class="form-label">Upload 10th Memo</label>
                                            <input class="form-control form-control-lg" id="formFileLg" type="file" name="image10">
                                        </div>
                            ...
                            <div class="row g-2 justify-content-md-around">
                                ...
                                <div class="col-md-11">
                                    ...
                                    <div class="mb-3">
                                        <label for="formFileLg" class="form-label">Upload 12th Memo</label>
                                        <input class="form-control form-control-lg" id="formFileLg" type="file" name="image12">
                                    </div>
 ...
 -->
					...
					%>
					<div style="text-align: center;margin-top:40px; margin-bottom:20px;">You have not submitted your personal details.</div>
				
					
					<div style="text-align: center;"><a class="btn bg-success" href="addProfile"><button type="button" class="btn bg-success">Click here to submit your Personal Details</button></a></div>
