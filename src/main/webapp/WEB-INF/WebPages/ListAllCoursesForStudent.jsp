                ...
                <div class="row justify-content-md-center" style="margin-top:50px;">
                    ...
                    <c:forEach var="cs" items="${list}"> 
                        <div class="card" style="margin-bottom:50px;">
                            <h5 class="card-header"><a href="#" class="btn btn-primary">${cs.cbranch}</a></h5>
                            <div class="card-body">
                            
                                <div class="row g-3 justify-content-md-evenly">
                                        
                                    
                                    <div class="col-md-3">
                                        <h5>No. Of Seats: ${cs.cseats}</h5>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-floating mb-3">
                                            <h5>Duration in Yrs: ${cs.cduration}</h5>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <h5>No. Of Semesters: ${cs.csems}</h5>
                                    </div>
