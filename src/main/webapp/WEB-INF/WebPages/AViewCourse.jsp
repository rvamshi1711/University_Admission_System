                        ...
                        <table class="table table-striped table-hover">
					        <thead>
					            <tr>
					              ...
					              <th scope="col">Duration in Yrs</th>
					        ...
					        <c:forEach var="cs" items="${list}"> 
					           		  <tbody>
										    <tr>
										      <th scope="row">${cs.cid}</th>
										      <td>${cs.cbranch}</td>
										      <td>${cs.cseats}</td>
										      <td>${cs.cduration}</td>
										      <td>${cs.csems}</td>
										      <td>
										      	<form method="get" action="editCourse/${cs.cid}"><button type="submit" class="btn btn-success">Edit</button></form>
										      </td>
										      <td>
										      		<form method="get" action="delcourse/${cs.cid}"><button type="submit" class="btn btn-danger">Delete</button></form>
										    	</td>
										    </tr>
