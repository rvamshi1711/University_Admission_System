                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                             ...
                             <li class="nav-item dropdown">
					          ...
					          <li><a class="btn bg-transparent" href="ViewApplications" role="button">View Applications</a></li>
                        ...
                        <table class="table table-striped table-hover">
					        <thead>
					            <tr>
					              ...
					              <c:forEach var="cs1" items="${list1}"> 
					              <th scope="col">${cs1.cbranch}</th>
					              </c:forEach>
					        ...
					        <c:forEach var="cs" items="${list}"> 
					           		  <tbody>
										    <tr>
										      <th scope="row" rowspan="2">${cs.emailId}</th>
										      <td>${cs.emailid}</td>
										      <td>${cs.branchName}</td>
										      <td >${cs.marks12}</td>
										      <td></td>
