                ...
                <div id="demo">
                    <table class="table table-striped table-hover">
					        ...
					        <c:forEach var="cs" items="${list}"> 
					           		  <tbody>
										    <tr>
										      <th scope="row"><a href="https://mail.google.com/mail/?view=cm&fs=1&to=${cs.emailid}" target="_blank">${cs.emailid}</a></th>
										      <td>${cs.phoneno}</td>
										      <td>${cs.title}</td>
										      <td>${cs.description}</td>
										      <td></td>
										      <td>
										      		<form method="get" action="delreport/${cs.id}"><button type="submit" class="btn btn-danger">Delete</button></form>
										    	</td>
