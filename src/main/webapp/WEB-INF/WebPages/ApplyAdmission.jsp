        ...
        <div class="row">
            ...
            <!--Navbar Section Ends-->
                <div id="demo">
                    ...
                    <div style="margin-top:4vh; text-align:center;"><h1>Apply For Admission</h1></div>
                <div class="row justify-content-md-evenly">
                    <div class="col-md-8">
			...
			try
			{
			    ...
			    String ss= "SELECT * from educational_details where emailid = '"+c.getEmailid()+"';";
				...
				if(rs.next())
				{
					String ss1= "SELECT * from preferencesforstoring where emailid = '"+c.getEmailid()+"';";
					...
					if(rs2.next())
					{
						%>
						<div class="row justify-content-md-center">
							<div class="alert alert-success col-md-12 justify-content-md-center" role="alert" style="text-align:center; margin-top:10vh;">
								<h1>Your Course Preferences are submitted to University.</h1>
							</div>
						</div>
							<%-- 
							 <form style="border: solid 1px; padding: 50px 60px; margin-top: 3vh; box-shadow:1px 1px 20px 0px; " method="POST" action="applyAdmission">
                            <!--First and last name-->
                            <c:forEach var="cb1" items="${list}">
                            <div class="row g-2 justify-content-md-around">
                                
                                
                                <div class="col-md-4">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="First Name" value="${cb1.getCbranch()}" readonly required>
                                        <label for="floatingInput">Branch Name</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="First Name" name="${cb1.getCbranch()}" value="<%=rs2.getInt("${cb1.getCbranch()}")%>" required>
                                        <label for="floatingInput">Preference</label>
                                    </div>
                                </div>
					...
					%>
						<div class="row justify-content-md-center" style="text-align:center;">${msg}</div>
                        <form style="border: solid 1px; padding: 50px 60px; margin-top: 3vh; box-shadow:1px 1px 20px 0px; " method="POST" action="applyAdmission">
                            <!--First and last name-->
                            <c:forEach var="cb" items="${list}">
                            <div class="row g-2 justify-content-md-around">
                                <input type="hidden" value="<%=c.getEmailid() %>" name="emailid">
                                <input type="hidden" value="<%=rs.getInt("percentage12")%>" name="marks12">
                                <div class="col-md-4">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" placeholder="First Name" value="${cb.getCbranch()}" readonly required>
                                        <label for="floatingInput">Branch Name</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="floatingInput" placeholder="First Name"  name="${cb.getCbranch()}" value="0" min="0" max="${bs}"
                                         required>
                                        <label for="floatingInput">Preference</label>
                                    </div>
                                </div>
                            ...
                            <button type="submit" class="btn btn-success">Submit</button>
                        		 ...
                        		 <%
                        			 ...
                        			 %>
                        			 <div style="text-align: center;margin-top:40px; margin-bottom:40px;">You have not submitted your Educational details.</div>
                        			 
                        			 	<div style="text-align: center;"><a class="btn bg-success" href="EducationDetails"><button type="button"  class="btn bg-success">Click here to submit your Educational Details</button></a></div>
